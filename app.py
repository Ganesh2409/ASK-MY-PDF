...
# Home Page
if choice == "🏠 Home":
    st.title("📄 ASK MY PDF App")
    st.markdown("""
    Welcome to **ASK  MY  PDF App**! 🚀
...
# Contact Page
    ...
    - **Email:** [ganeshchowdhary2409@gmail.com](mailto:ganeshchowdhary2409@gmail.com) ✉️
    - **GitHub:** [Contribute on GitHub](https://github.com/Ganesh2409/ASKMYPDF) 🛠️
